...
class CmsContentSeeder extends Seeder
{
    ...
    private function blocks(): array
    {
        ...
        return [
            ...
            ['key' => 'feature_2_title', 'type' => $text, 'section' => 'features', 'sort_order' => 3,
                'content' => 'Digital agreements'],
            ['key' => 'feature_2_description', 'type' => $text, 'section' => 'features', 'sort_order' => 4,
                'content' => 'Generate, sign and version rental agreements on screen. Every change is captured immutably.'],

            ['key' => 'feature_3_title', 'type' => $text, 'section' => 'features', 'sort_order' => 5,
                'content' => 'Smart invoicing'],
            ['key' => 'feature_3_description', 'type' => $text, 'section' => 'features', 'sort_order' => 6,
                'content' => 'Recurring billing, prorated vehicle changes and automated late fees — accurate to the cent.'],

            ['key' => 'feature_4_title', 'type' => $text, 'section' => 'features', 'sort_order' => 7,
                'content' => 'Workshop & maintenance'],
            ['key' => 'feature_4_description', 'type' => $text, 'section' => 'features', 'sort_order' => 8,
                'content' => 'A QR-driven mechanic portal for service logs, parts and labour, with full cost tracking.'],

            ['key' => 'feature_5_title', 'type' => $text, 'section' => 'features', 'sort_order' => 9,
                'content' => 'Customer portal'],
            ['key' => 'feature_5_description', 'type' => $text, 'section' => 'features', 'sort_order' => 10,
                'content' => 'Let customers view invoices, download signed agreements and pay online from their own login.'],

            ['key' => 'feature_6_title', 'type' => $text, 'section' => 'features', 'sort_order' => 11,
                'content' => 'Reports & AI insights'],
            ['key' => 'feature_6_description', 'type' => $text, 'section' => 'features', 'sort_order' => 12,
