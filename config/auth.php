...
return [
    ...
    */
    ...
    'guards' => [
        ...
        // DVARO portals — each portal is an isolated guard and must never
        // share session state with another. Provider models are scaffolded
        // to App\Models\User for now; each portal gets its own model later.
        'tenant' => [
            'driver' => 'session',
    ...
    */
    ...
    'providers' => [
        ...
        'mechanics' => [
            'driver' => 'eloquent',
            'model' => App\Modules\Workshop\Models\Mechanic::class,
        ],
    ],
