...
/**
 * Sends 14-day AGREEMENT-END reminders to each tenant's admin.
 *
 * Vehicle reminders (registration, insurance, service by date/km) moved to
 * FleetReminderService in Session 30 — a daily digest to ALL staff with
 * due-soon + overdue stages. They are deliberately NOT sent from here any more
 * (would double-notify).
 *
