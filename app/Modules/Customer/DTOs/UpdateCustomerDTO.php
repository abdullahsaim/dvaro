...
/**
 * Carries validated customer-edit data into UpdateCustomerAction.
 *
 * Same fields as CreateCustomerDTO. Blacklist fields are deliberately absent —
 * blacklist state is mutated ONLY through Blacklist/UnblacklistCustomerAction,
 * never on a general edit.
 */
class UpdateCustomerDTO extends BaseDTO
{
    ...
    /**
     * Attributes for $customer->update(). No blacklist keys — see class doc.
     *
