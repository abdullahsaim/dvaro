<script setup>
// Multiline text field, same label/help/error contract as Input. v-model bound.
...
const fieldClasses = computed(() => [
    'block w-full rounded-control border bg-white px-3 py-2 text-sm text-ink-900 shadow-subtle transition-colors duration-150',
