<script setup>
// Mechanic-portal forgot-password request. FUNCTIONAL ONLY — design pass later.
// Posts to /mechanic/{tenant_slug}/forgot-password. Resets the PASSWORD only.
...
function submit() {
    form.post(`/mechanic/${slug.value}/forgot-password`);
}
</script>
...
<template>
    <PublicLayout>
        ...
        <div class="mx-auto flex min-h-screen max-w-sm flex-col justify-center px-4">
            ...
            <Link :href="`/mechanic/${slug}/login`" class="mt-6 text-sm text-slate-500 hover:underline dark:text-slate-400">
