<script setup>
// Mechanic-portal reset-password form. FUNCTIONAL ONLY — design pass later.
// Posts to /mechanic/{tenant_slug}/reset-password with the token + email.
...
function submit() {
    form.post(`/mechanic/${slug.value}/reset-password`, {
