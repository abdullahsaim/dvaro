...
const form = useForm({
    ...
    registration_expiry: toDateInput(props.vehicle.registration_expiry),
    last_service_date: toDateInput(props.vehicle.last_service_date),
    next_service_due: toDateInput(props.vehicle.next_service_due),
    notes: props.vehicle.notes ?? '',
    service_interval_months: props.vehicle.service_interval_months ?? '',
    service_interval_km: props.vehicle.service_interval_km ?? '',
    last_service_odometer: props.vehicle.last_service_odometer ?? '',
});
